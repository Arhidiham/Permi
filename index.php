...
var_dump(Permission::isAllowed($king, Constants::PERMISSION_UPDATE, $kingInvoice));
print_r(PHP_EOL);

$nurseInvoice = new Invoice($nurse);
print_r('Nurse allowed update on invoice they created: ');
var_dump(Permission::isAllowed($nurse, Constants::PERMISSION_UPDATE, $nurseInvoice));
print_r(PHP_EOL);

print_r('King allowed update on invoice they did not create: ');
var_dump(Permission::isAllowed($king, Constants::PERMISSION_UPDATE, $nurseInvoice));
print_r(PHP_EOL);

print_r('Nurse allowed update on invoice they did not create: ');
var_dump(Permission::isAllowed($nurse, Constants::PERMISSION_UPDATE, $kingInvoice));
print_r(PHP_EOL);
